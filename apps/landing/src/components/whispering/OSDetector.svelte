...
<Button
	href={downloadUrl}
	size="lg"
	class="w-full sm:w-auto min-w-[200px] min-h-[48px] shadow-lg hover:shadow-xl transition-all group font-semibold"
>
	<svg
		class="w-5 h-5 mr-2 group-hover:translate-y-0.5 transition-transform"
		fill="none"
		stroke="currentColor"
		viewBox="0 0 24 24"
	>
